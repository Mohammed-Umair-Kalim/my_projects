...

{
    ...
    if(currency_convertor.choices === "Exit"){console.log("Exitting...");break}
    ...
    if(currency_convertor.choices === "USD to PKR")
    {
        ...
        if(pkr_usd.Q1){console.log(chalk.rgb(255,255,56)(pkr_usd.Q1 * $ * PKR))}
    }
    ...
    if(currency_convertor.choices === "PKR to USD")
    {
        ...
        if(usd_pkr.Q2){console.log(chalk.cyanBright(usd_pkr.Q2 * $ / PKR))}
    }
    ...
    if(currency_convertor.choices === "USD to Euro")
    {
        ...
        if(usd_euro.Q3){console.log(chalk.magentaBright(usd_euro.Q3 * $ * Euro))}
    }
    ...
    if(currency_convertor.choices === "Euro to USD")
    {
        ...
        if(euro_usd.Q4){console.log(chalk.blueBright(euro_usd.Q4 * $ / Euro))}
    }
    ...
    if(currency_convertor.choices === "USD to Pound")
    {
        ...
        if(usd_pound.Q5){console.log(chalk.redBright(usd_pound.Q5 * $ * pound))}
    }
    ...
    if(currency_convertor.choices === "Pound to USD")
    {
        ...
        if(pound_usd.Q6){console.log(chalk.rgb(211,56,255)(pound_usd.Q6 * $ / pound))}
    }
}